 ...
 * @author WINDOWS 10
 */
public class MessageProcessorTest1841720157Andri {
    MessageProcessor1841720157Andri mProcessor;
    ...
    public MessageProcessorTest1841720157Andri(){
        mProcessor = new MessageProcessor1841720157Andri();
