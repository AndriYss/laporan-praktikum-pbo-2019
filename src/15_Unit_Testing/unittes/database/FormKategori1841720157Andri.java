 ...
 * @author WINDOWS 10
 */
public class FormKategori1841720157Andri extends javax.swing.JFrame {

    /**
     * Creates new form FrmKategori
     */
    public FormKategori1841720157Andri() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData() {
        ...
        ArrayList<Kategori1841720157Andri> list = new Kategori1841720157Andri().getAll();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Kategori1841720157Andri kat : list) {
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1841720157Andri> list = new Kategori1841720157Andri().search(keyword);
        Object rowData[] = new Object[3];
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtKeterangan, javax.swing.GroupLayout.DEFAULT_SIZE, 80, Short.MAX_VALUE)
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1841720157Andri kat = new Kategori1841720157Andri().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKategori1841720157Andri.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormKategori1841720157Andri().setVisible(true);
            }
        });
    }
