 ...
 * @author WINDOWS 10
 */
public class Peminjaman1841720157Andri {
    private int idpeminjaman;
    private Anggota1841720157Andri anggota = new Anggota1841720157Andri();
    private Buku1841720157Andri buku = new Buku1841720157Andri();
    private String tanggalpinjam;
    private String tanggalkembali;

    public Peminjaman1841720157Andri() {
    }

    public Peminjaman1841720157Andri(Anggota1841720157Andri anggota, Buku1841720157Andri buku, String tanggalpinjam, String tanggalkembali) {        
    ...
    public Anggota1841720157Andri getAnggota() {
        return anggota;
    }

    public void setAnggota(Anggota1841720157Andri anggota) {
        this.anggota = anggota;
    }

    public Buku1841720157Andri getBuku() {
        return buku;
    }

    public void setBuku(Buku1841720157Andri buku) {
        this.buku = buku;
    }
    ...
    public Peminjaman1841720157Andri getById(int id){
        Peminjaman1841720157Andri peminjaman = new Peminjaman1841720157Andri();
        ResultSet rs = DBHelper1841720157Andri.selectQuery("SELECT "
        ...
        try {
            while(rs.next()){
                peminjaman = new Peminjaman1841720157Andri();
    ...
    public ArrayList<Peminjaman1841720157Andri> getAll(){
        ArrayList<Peminjaman1841720157Andri> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720157Andri.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
                                        +"      p.tanggalkembali AS tanggalkembali, "
    ...
    public ArrayList<Peminjaman1841720157Andri> search(String keyword){
        ArrayList<Peminjaman1841720157Andri> ListPeminjaman = new ArrayList();
        ResultSet rs = DBHelper1841720157Andri.selectQuery("SELECT "
                                        +"      p.idpeminjaman AS idpeminjaman, "
                                        +"      p.tanggalpinjam AS tanggalpinjam, "
    ...
    public void save(){
        if(getById(idpeminjaman).getIdpeminjaman()== 0){
            String SQL = "INSERT INTO peminjaman (idanggota, idbuku, tanggalpinjam, tanggalkembali) VALUES("
                    ...
                    +"      '"+ this.tanggalkembali + "' "
                    +"      )";
            this.idpeminjaman = DBHelper1841720157Andri.insertQueryGetId(SQL);
